...
class CommentServiceTest {
    ...
    public PostDto.PostInsertComment comment (){
        PostDto.PostInsertComment insertComment = PostDto.PostInsertComment.builder()
                .id(1L)
                .author(userInfo())
    ...
    void insertComment()throws Exception{
        ...
        Comment saveComment = commentService.addComment("xxxxxxxxx",post.getId(), user.getId() );
    ...
    public void addComment_실패() throws Exception {
        ...
        assertThrows(UserNotFoundException.class, () -> {
            Comment result = commentService.addComment("xxxxxxxxx",post.getId(), user.getId() );
        });
    }
